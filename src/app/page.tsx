        ...
        <section
          ...
          <div className="grid">
            <article
              ...
              <p className="muted">
                Hero letters arrive with blur → snap, while sections follows
                with a soft lift.
              </p>
            </article>
            ...
            <article
              ...
              <p className="muted">
                A dominant dark ink base with neon accents, all driven by
                variables.
              </p>
            </article>
            ...
            <article
              ...
              <p className="muted">
                Buttons and cards lift with crisp shadows and accessible focus
                rings.
              </p>
            </article>
          </div>
        ...
        <section
          ...
          <div
            ...
            <div>
              ...
              <p className="muted">
                Tell me what kind of site this will be (portfolio, agency,
                product, shop) and I’ll tune the theme.
              </p>
            </div>
